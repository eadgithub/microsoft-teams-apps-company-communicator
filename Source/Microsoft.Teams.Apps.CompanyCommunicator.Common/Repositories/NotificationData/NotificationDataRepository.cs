...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public class NotificationDataRepository : BaseRepository<NotificationDataEntity>
    {
        ...
        public async Task<IEnumerable<NotificationDataEntity>> GetQueriedSentNotificationsAsync(string searchQuery)
        {
            ...
            var filteredResult = new List<NotificationDataEntity>(result).FindAll(x => x.SenderName.ToLower().Contains(searchQuery.ToLower()) || x.DepartmentName.ToLower().Contains(searchQuery.ToLower()) || x.Title.ToLower().Contains(searchQuery.ToLower()));
        ...
        public async Task<string> MoveDraftToSentPartitionAsync(NotificationDataEntity draftNotificationEntity)
        {
            try
            {
                ...
                var sentNotificationEntity = new NotificationDataEntity
                {
                    ...
                    SentDate = null,
                    IsDraft = false,
                    SenderName=draftNotificationEntity.SenderName,
                    DepartmentName=draftNotificationEntity.DepartmentName,
